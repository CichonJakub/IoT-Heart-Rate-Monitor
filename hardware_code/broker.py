...
import ssl
import sys
import statistics # potrzebne do obrabiania pomiarow
import os
...
def measure():
    ...
    time_limit = 11
    drawback_time = 11 # jezeli jest rowne 10 to nie chce konczyc polaczenia
    ...
    def on_message(client, userdata, message):
        #if datetime.now().second != (stamp+10):
    ...
    # timestamp 10 sek, pytanie czy nie lepiej to ograniczyc u Ani, która będzie odpalać ten skrypt
    #client.subscribe("some/topic", 2) #subscribe
